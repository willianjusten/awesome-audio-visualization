...
- [Here Comes The Sun](http://beatlescode.cc/) - A visual representation of The Beatles’ song Here Comes The Sun dynamically generated by an algorithm developed with Processing and Processing.js by Marcio Ribeiro.
...
- [Bohemian Rhapsichord](http://static.echonest.com/BohemianRhapsichord/index.html) - is a web app that turns the song Bohemian Rhapsody into a musical instrument by Paul Lamere.
...
- [Step sequencer](http://codepen.io/woodwork/full/rxrLqa/) - create musics with this sequencer by Joe Harry.

- [WebGL Spacesphere using Three.js](http://codepen.io/luigimannoni/full/yYZjjV) - an immersion to the space by Luigi Mannoni.
...
- [Robert Hodgin](http://roberthodgin.com/) - a creative coder living in Brooklyn, o-creator of the Cinder C++.
...
- [Patrick Heng](http://hengpatrick.fr/) - creative front-end developer studied at Hetic and Gobelins and work at Grouek.
